...
const Home = () => {
	return (
		<div className="home container m-0 p-0 border-0">
			<div className="banner container pt-5 pb-5">
				<div className="wrapper mt-5">
					...
					<div className="mt-2">
							...
							<Link className="btn btn-light me-5 ms-0 mb-4 mt-4 rounded-5 btn-download">
								<i className="bx bx-download"></i> Descargar manual
							</Link>

							<Link className="btn btn-info me-5 ms-0 mb-4 mt-4 rounded-5 text-light">
			...
			<div className="about">
				...
				<div className="text-group">
					...
					<p>
						...
						porro iusto reprehenderit deserunt eligendi tenetur corrupti nisi
						nemo beatae cumque perferendis minima, temporibus pariatur?
						Cupiditate corporis commodi quasi eveniet nesciunt?
					</p>
				</div>
			</div>
			<svg
